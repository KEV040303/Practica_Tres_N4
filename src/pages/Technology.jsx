          ...
          <nav className="flex flex-col gap-10 font-Bellefair text-[32px] items-center">
            {data.technology.map((technology) => (
              <NavLink
                ...
                className={({ isActive }) =>
                  `flex justify-center h-[80px] w-[80px] rounded-full border-white border-[1px]  items-center ${
                    isActive
                      ? "bg-white text-SpaceDark"
                      : "hover:text-opacity-55 hover:border-opacity-25"
                  }`
                }
              >
                {technology.id}
