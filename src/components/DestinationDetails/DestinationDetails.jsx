  ...
  return (
    <div className="flex gap-48">
      ...
      <div className="flex flex-col">
        ...
        <p className="pb-12 w-[444px] font-Barlow text-SoftViolet font-normal text-[18px]">
          {destination.description}
        </p>
        <div className="h-[1px] w-[444px] text-white bg-white opacity-20 mb-6"></div>
        <div className="flex justify-between w-[370px]">
          <div>
            <h3 className="uppercase font-normal text-SoftViolet font-BarlowCondensed text-[14px]">
              Avg. Distance
            </h3>
