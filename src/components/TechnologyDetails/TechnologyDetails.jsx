  ...
  return (
    <div className="flex pl-16 gap-12 items-center justify-end w-full">
      <div className="flex flex-col w-full mb-12">
        <h3 className="font-BarlowCondensed text-[16px] text-SoftViolet">
          THE TERMINOLOGY…
        </h3>
        <h2 className="text-[32px] font-Bellefair uppercase tracking-[2px] mb-2">
          {technology.name}
        </h2>
